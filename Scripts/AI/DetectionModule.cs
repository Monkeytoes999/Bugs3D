...
namespace Unity.Bugs.AI
{
    public class DetectionModule : MonoBehaviour
    {
        ...
        public bool IsTargetVeryClose { get; private set; }
        ...
        public virtual void HandleTargetDetection(Actor actor, Collider[] selfColliders)
        {
            ...
            IsTargetVeryClose = KnownDetectedTarget != null && Vector3.Distance(transform.position, KnownDetectedTarget.transform.position) < 1.3f;
